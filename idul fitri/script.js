...
const audio = new Audio('https://srv.neoxr.tk/f/W4eFXH.mp3'); // Ganti 'nama_file_lagu.mp3' dengan URL file lagu yang ingin Anda gunakan!
...
Iya.addEventListener("click", function () {
    ...
    if (Iya.value == 1) {
        ...
        Text.innerHTML = "Assalamualaikum, Hai ini saya Ramos <br>dan Segenap keluarga besar.";
        ...
        Text.classList.remove('text-animate');
        void Text.offsetWidth; 
        Text.innerHTML = "Mungkin kalimat ini tidak seindah<br>zikir subuhmu";
        Text.classList.add('text-animate');
    } else if (Iya.value == 4) {
        Text.classList.remove('text-animate');
        void Text.offsetWidth; 
        ...
        Text.classList.remove('text-animate');
        void Text.offsetWidth; 
        Text.innerHTML = "Begitu juga tak semerdu solawat<br>sebelum fajar terbenam.<br>Namun, doa dan ucapan ini setulus sujud<br>di setiap rakaat salat";
        Text.classList.add('text-animate');
    } else if (Iya.value == 6) {
        Text.classList.remove('text-animate');
        void Text.offsetWidth; 
        ...
        Text.innerHTML += '<br><a href="https://wa.me/6285830387714?text=Selamat+Idul+fitri+Ramos+Mohon+Maaf+Lahir+Dan+Batin😇" target="_blank" rel="noopener noreferrer"><button style="background-color: white;">Kirim Pesan</button></a>';
        Text.classList.add('text-animate');
        Iya.remove();
